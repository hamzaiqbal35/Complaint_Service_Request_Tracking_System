...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['auth', 'role:admin'])->group(function () {
        ...
        Route::prefix('admin')->name('admin.')->group(function () {
            ...
            Route::patch('complaints/{complaint}', [ComplaintAdminController::class, 'update'])->name('complaints.update');
...
Route::middleware(['auth', 'role:admin'])->group(function () {
    Route::post('/admin/users/{user}/verify-email', [UserController::class, 'verifyEmail'])
